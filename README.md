...
├── AGENTS.md                # Codex / Antigravity 等其他 AI 的规则（指向 CLAUDE.md 同一套约定）
├── ai/common/git-workflow.md # Git 提交与推送工作流（新机器配置 + 提交纪律）
...
- 提交前逐一 `git diff` 已暂存内容核查，规程见 [ai/common/git-workflow.md](ai/common/git-workflow.md)。
